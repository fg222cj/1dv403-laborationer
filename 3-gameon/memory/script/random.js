	...
	getPictureArray: function(rows, cols)
	{
	   ...
	   for(var i=0; i<numberOfImages; i++)
		...
		{		
			...
			do
			{
				// byta ut if mot while här för att effektivisera kanske?
				// Hade inte det bästa varit att trycka in värden i arrayet i ordning och sen blanda det? Om det går på nåt bra sätt?
				...
				// byte ut if mot while här för att effektivisera kanske?
				if(imageTwoOK == false)
				{
